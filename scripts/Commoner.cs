...
public partial class Commoner : Person
{
    [Export] public int SpritesAmmount = 2;
    [Export] public AnimationPlayer commonerAnimate = null!;
    ...
    {
        crowdType = CrowdType.Commoner;
        string path = "res://assets/characters/commoner/commoner" + (GD.Randi() % SpritesAmmount + 1);
